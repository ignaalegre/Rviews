...
export default function Header() {
  ...
  return (
    <header className="bg-gray-900 text-white px-4 py-3 shadow-md">
      <nav className="flex flex-col sm:flex-row sm:items-center sm:justify-between max-w-screen-2xl mx-auto gap-4">
        {/* Izquierda: Logo, sidebar y búsqueda */}
        <div className="flex items-center justify-between sm:justify-start gap-4 w-full sm:w-auto">
          ...
          <Link to="/" className="text-xl sm:text-2xl font-bold hover:scale-110 transition-transform">
            Rviews
          </Link>
