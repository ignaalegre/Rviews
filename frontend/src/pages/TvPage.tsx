...
const TvPage = () => {
    ...
    return (
        <div className="flex flex-col w-full h-full overflow-x-hidden">
            ...
            {/* Trailers */}
            <h1 className="font-extrabold text-xl md:text-2xl lg:text-4xl text-white text-center p-12">Trailers</h1>
            {trailers.length > 0 ? (
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="space-y-6">
                        {apiReviews?.results.reverse().map((review, index) => (
                            <div key={index} className="bg-white/20 backdrop-blur-md p-6 rounded-lg shadow-lg text-white hover:scale-[1.01] transition duration-300">
